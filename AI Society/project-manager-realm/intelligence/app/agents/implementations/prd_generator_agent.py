...
class PRDGeneratorAgent(BaseAgent):
    ...
    def _get_prompt_name(self) -> str:
        """Get the prompt template name for PRD generator agent.
        
        Returns:
            Prompt name
        """
        return "v1_prd-generator.prompt"
    ...
    def _parse_response(self, response_content: str) -> Dict[str, Any]:
        ...
        Args:
            response_content: Raw LLM response (expected to be JSON with PRD, possibly wrapped in markdown code blocks)
