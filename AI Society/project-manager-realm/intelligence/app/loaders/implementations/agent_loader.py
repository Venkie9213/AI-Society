...
"""Agent configuration loader - loads from agents/config/*.yaml."""
...
class AgentLoader(BaseLoader):
    """Loads agent configurations from agents/config/ directory."""
    ...
    def __init__(self, settings: Settings, cache_enabled: bool = True):
        ...
        self.agents_path = settings.agents_path / "config"
    
    def load_agents(self) -> Dict[str, Any]:
        """Load all agent configurations from agents/config/ directory.
